"""Unit tests for stevefulme1.vastdata.vast_group module."""
...
class TestCreate:
    ...
    def test_create_resource(self, mock_get_client):
        ...
        from ansible_collections.stevefulme1.vastdata.plugins.modules.vast_group import VastGroup
        obj = VastGroup(module)
...
class TestDelete:
    ...
    def test_delete_resource(self, mock_get_client):
        ...
        from ansible_collections.stevefulme1.vastdata.plugins.modules.vast_group import VastGroup
        obj = VastGroup(module)
        obj.delete_resource({"id": 42, "name": "testgroup"})

        mock_client.delete.assert_called_once_with("/api/nativegroups/42/")


class TestUpdate:
    """Test vast_group update."""
    ...
    def test_update_resource(self, mock_get_client):
        ...
        from ansible_collections.stevefulme1.vastdata.plugins.modules.vast_group import VastGroup
        obj = VastGroup(module)
        result = obj.update_resource({"id": 1, "name": "testgroup"})

        mock_client.patch.assert_called_once()
        assert result["name"] == "testgroup-updated"
...
class TestErrorHandling:
    ...
    def test_not_found_on_delete(self, mock_get_client):
        ...
        try:
            obj.delete_resource({"id": 999, "name": "testgroup"})
        except Exception as e:
            assert "404" in str(e)
