"""Unit tests for stevefulme1.vastdata.vast_user module."""
...
class TestCreate:
    ...
    def test_create_resource(self, mock_get_client):
        ...
        from ansible_collections.stevefulme1.vastdata.plugins.modules.vast_user import VastUser
        obj = VastUser(module)
...
class TestDelete:
    ...
    def test_delete_resource(self, mock_get_client):
        ...
        from ansible_collections.stevefulme1.vastdata.plugins.modules.vast_user import VastUser
        obj = VastUser(module)
        obj.delete_resource({"id": 42, "name": "testuser"})

        mock_client.delete.assert_called_once_with("/api/nativeusers/42/")


class TestUpdate:
    """Test vast_user update."""
    ...
    def test_update_resource(self, mock_get_client):
        ...
        from ansible_collections.stevefulme1.vastdata.plugins.modules.vast_user import VastUser
        obj = VastUser(module)
        result = obj.update_resource({"id": 1, "name": "testuser"})

        mock_client.patch.assert_called_once()
        assert result["name"] == "testuser-updated"
...
class TestErrorHandling:
    ...
    def test_not_found_on_delete(self, mock_get_client):
        ...
        try:
            obj.delete_resource({"id": 999, "name": "testuser"})
        except Exception as e:
            assert "404" in str(e)
